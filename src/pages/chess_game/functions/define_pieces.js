const definePieces = () => {
    ...
    pieces_table[7][0] = "wrook r1 0";

    for (let i = 0; i < 8; i++)
        pieces_table[i][1] = 'wpawn p' + i + ' 0';

    pieces_table[0][7] = "brook r0 0";
    ...
    pieces_table[7][7] = "brook r1 0";

    for (let i = 0; i < 8; i++)
        pieces_table[i][6] = 'bpawn p' + i + ' 0';
